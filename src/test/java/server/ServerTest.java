...
public class ServerTest extends TestCase {
    ...
    public void testListeCoursSessionSpecifiee() {
        try {
            ...
            ArrayList<Object> listecours = (ArrayList<Object>) os.readObject(); //ajouter objet dans fichier
            // "sérialisé" pour le client
    ...
    public void testUn() {
        try {
            FileWriter fw = new FileWriter("C:\\Users\\tokat\\IdeaProjects\\TP2\\src\\main\\java\\server" +
                    "\\data\\inscription.txt", true);
...
@Test
    ...
    try {
        ...
        ArrayList<Course> listecours = (ArrayList<Course>) os.readObject(); //ajouter objet dans fichier "sérialisé"
        // pour le client
        System.out.println(Arrays.asList(listecours)); //pour débogage
        for (Object o : listecours) {
